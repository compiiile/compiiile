...
# Some title with an icon <Icon name="github-logo" />

```
# Some title with an icon <Icon name="github-logo" />
```

Icons in body text: <i class="ph ph-smiley"></i>

```
Icons in body text: <i class="ph ph-smiley"></i>
In Vue components, use the following syntax: <i-ph-user />
```

A code block with a custom filename:
